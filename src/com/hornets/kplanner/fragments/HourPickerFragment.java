 ...
 * @version November 24 2013 {@link HourPickerFragment} implements the Hour
 *          Picker dialog
 */
public class HourPickerFragment extends DialogFragment {
	...
	public void onAttach(Activity activity) {
		...
		try {
			// Instantiate the IHourPickerListener so we can send events to the
			// host
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		View dialogView = inflater
				.inflate(R.layout.fragment_numberpicker, null);
	...
	/**
	 * Sets the default values for the hour picker
	 * 
	 * @param dialogView
	 */
